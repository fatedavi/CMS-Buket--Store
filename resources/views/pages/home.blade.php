...
<section class="relative min-h-[90vh] flex items-center overflow-hidden">
    ...
    {{-- Gambar bunga blur di belakang teks hero (uji dengan gambar yang pasti ada) --}}
    <img src="/images/hero-bg.png" alt="Buket Bunga Blur" class="absolute left-0 top-1/2 -translate-y-1/2 w-[600px] max-w-[60vw] opacity-60 blur-2xl pointer-events-none select-none z-[1] hidden md:block" style="mix-blend-mode: lighten;" data-aos="fade-in" data-aos-delay="80">
    ...
    {{-- Dekorasi gambar bunga di hero section --}}
    {{-- <img src="/images/hero-flower.png" alt="Dekorasi Buket Bunga" class="hidden md:block absolute right-0 bottom-0 w-96 max-w-[40vw] pointer-events-none select-none" style="z-index:2;" data-aos="fade-left" data-aos-delay="200"> --}}
