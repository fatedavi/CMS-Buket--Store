...
<div x-data="productPreview()" class="mb-6">
    <div class="flex items-center justify-between mb-6">
        <h1 class="font-playfair text-2xl text-dark-oak">Tambah Produk Baru</h1>
    ...
    <div class="grid grid-cols-1 gap-6" :class="showPreview ? 'lg:grid-cols-5' : ''">
        ...
        <div :class="showPreview ? 'lg:col-span-3' : ''">
            <div class="bg-white rounded-2xl border border-amber-100 p-6">
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" id="form-product-create" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price" value="{{ old('price') }}" min="0" step="500" x-model="form.price"
                    ...
                    <div class="flex gap-3 pt-2">
                        <button type="button" @click.prevent="openConfirm('save', 'Simpan Produk', 'Simpan produk baru? Tindakan ini akan menyimpan semua data yang telah diisi.', '', 'form-product-create')" class="bg-sage-green text-white rounded-xl px-6 py-2.5 font-medium hover:brightness-110 transition-all">Simpan Produk</button>
        ...
        <div x-show="showPreview" class="lg:col-span-2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-4" x-transition:enter-end="opacity-100 translate-x-0">
            <div class="sticky top-8">
                <div class="bg-white rounded-2xl border border-amber-100 p-4 mb-4">
                    ...
                    {{-- Product card — matches homepage style exactly --}}
