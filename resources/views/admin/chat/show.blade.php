...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <form action="{{ route('admin.chat.close', $conversation) }}" method="POST" id="delete-form-conversation-{{ $conversation->id }}">
            @csrf
            <button type="button" @click.prevent="openConfirm('delete', 'Tutup Chat', 'Tutup percakapan ini?', '', 'conversation-{{ $conversation->id }}')" class="flex items-center gap-1.5 border border-terracotta text-terracotta rounded-xl px-3 py-1.5 text-xs hover:bg-terracotta hover:text-white transition-all">
